    ...
    return(
        <div className="Ancestor animate__animated animate__fadeInUp">
           ...
           <section className="Mother1">
                ...
                <video className="eventVideo" src={InPerson} autoPlay loop muted/>
            </section>
            ...
            <section className="Mother2">
                ...
                <video className="eventVideo" src={Virtual} autoPlay loop muted/>
            </section>
            ...
            <section className="Mother3">
                ...
                <video className="eventVideo" src={Hybrid} autoPlay loop muted/>
            </section>
           </nav>
        </div>
    )
