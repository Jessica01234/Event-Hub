...
function HybridEventForm() {
    ...
    const updateAttendeesDetailInLocalStorage = (newEvent) => {
        const existingAttendee = JSON.parse(localStorage.getItem('HybridGuests')) || [];
        const eventIdParam = eventId || '';     
        const updatedAttendee = [...existingAttendee, { ...newEvent, eventId: eventIdParam }];
        localStorage.setItem('HybridGuests', JSON.stringify(updatedAttendee));
    };
...
export default HybridEventForm;
